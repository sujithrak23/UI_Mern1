...
export default function SaravanaHotel() {
  return (
    <>
    <div
        style={{
        ...
        > 
         ...
         <div className='container' style={{width:'1200px'}}>
          <div>
            <Image 
            src="https://img.freepik.com/premium-photo/table-full-food-including-rice-curry-plate-food_900958-7307.jpg?size=626&ext=jpg&uid=R131645230&ga=GA1.1.456192605.1702699190&semt=ais" 
            fluid 
            style={{width:'100%',height:'450px'}}
            />;
            <h1 style={{color:'white'}}>Saravana Bhavan</h1>
            <h5 style={{color:'gray'}}>Pushpha,Tirupur</h5>
            <h5 style={{color:'gray'}}>14km ago</h5>
