...
export default function SageHotel() {
  return (
    <>
    <div
        style={{
        ...
        > 
         ...
         <div className='container' style={{width:'1100px'}}>
          <div>
            <Image 
            src="https://img.freepik.com/free-photo/variation-thai-cuisine-with-bell-peppers-bokchoy-wooden-desk-against-black-background_23-2148093088.jpg?size=626&ext=jpg&uid=R131645230&ga=GA1.1.456192605.1702699190&semt=ais" 
            fluid 
            style={{width:'100%',height:'450px'}}
            />;
            <h1 style={{color:'white'}}>Ssge & Salt</h1>
            <h5 style={{color:'gray'}}>ArulPuram,Palladam Road</h5>
            <h5 style={{color:'gray'}}>48km ago</h5>
