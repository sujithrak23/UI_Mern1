...
export default function ThemeHotel() {
  return (
    <>
    <div
        style={{
        ...
        > 
         ...
         <div className='container' style={{width:'1200px'}}>
          <div>
            <Image 
            src="https://img.freepik.com/free-photo/top-view-table-full-delicious-food-composition_23-2149141353.jpg?size=626&ext=jpg&uid=R131645230&ga=GA1.1.456192605.1702699190&semt=ais" 
            fluid 
            style={{width:'100%',height:'450px'}}
            />;
            <h1 style={{color:'white'}}>Grand Hotel</h1>
            <h5 style={{color:'gray'}}>P.N. Road,Tirupur</h5>
            <h5 style={{color:'gray'}}>34km ago</h5>
